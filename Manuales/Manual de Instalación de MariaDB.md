...
MYSQL\_ROOT\_PASSWORD: contraseña\_root

MYSQL\_DATABASE: gira\_db

MYSQL\_USER: gira\_user

MYSQL\_PASSWORD: contraseña\_user
...
Crea automáticamente la base de datos gira\_db

Crea el usuario gira\_user
...
docker exec -it <contenedor\_mariadb> mysql -u root -p
...
CREATE USER 'gira\_user'@'%' IDENTIFIED BY 'contraseña\_user';

GRANT ALL PRIVILEGES ON gira\_db.\* TO 'gira\_user'@'%';
...
(aula, dispositivo, fecha, hora\_inicio, hora\_fin, curso)
